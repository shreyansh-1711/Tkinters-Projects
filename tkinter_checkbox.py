...
#     print(check.get())
#
# c1 = Checkbutton(root, text="Accept terms and condition", font="arial 20 bold", onvalue=1, offvalue=0, variable=check)
# c1.grid(row=0, column=0)
#
# check.set("off")
#
# b1 = Button(root, text="Ok", font="arial 20 italic", command=show)
